...
/**
 * This class represents a cell used to make up a Map object. Each cell has a
 * type and is drawn in a different colour. Cells know about their neighbors (if
 * they are set using setNeighbor method). The neighbors of a cell are accessed
 * by an index 0, 1, 2, ... The neighbours of a cell are indexed as follows: the
 * 0 index is for the top neighbour. Indexes for the other neighbours progress
 * incrementally clockwise from 0 to 3. Eg. 0 --- 3 | | 1 --- 2
 * 
 * @author CS1027
 *
 */
public class MapCell extends CellComponent {
	...
	public static enum CellType {
		BLOCK, INITIAL, CUSTOMER, CROSSING, INITIAL_PROCESSED, CUSTOMER_PROCESSED, INITIAL_POPPED, IN_STACK, OUT_STACK,
	 ...
	 * 
	 * @param t     the CellType to create
	 * @param delay time that the program wairts before moving to next cell
	 */
	 ...
	 * 
	 * The index for the neighbor indicates which side of the cell this new neighbor
	 * is on: 0-3 inclusive.
	 * 
	 ...
	 * 
	 * @return true if this is a cell representing a block of buildings, false
	 *         otherwise.
	 */
	...
	/**
	 * This method marks the power station cell as the initial cell and updates the
	 * cell's colour
	 */
	 ...
	 * 
	 * @param t The type of the cell; used to set the color
	 */
